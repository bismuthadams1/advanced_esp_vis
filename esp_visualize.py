...
qm_esp = ESPProcessor(prop_store_path = '/Users/localadmin/Documents/projects/QM_ESP_Psi4/examples/prop_test_2.db', port = 8100, molecule = MOLECULE_STR, conformer = CONFORMER) 
...
qm_esp.add_on_atom_esp(partial_charges,['mmff94'])
